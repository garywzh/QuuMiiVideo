...
public class HlsRendererBuilder implements RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url, DemoPlayer player) {
            ...
            playlistFetcher = new ManifestFetcher<>(url, new OkHttpDataSource(RequestHelper.getClient(), userAgent, null),
                    parser);
        }
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            DataSource dataSource = new OkHttpDataSource(RequestHelper.getClient(), userAgent, null, bandwidthMeter);
            ...
            if (preferWebvtt) {
                DataSource textDataSource = new OkHttpDataSource(RequestHelper.getClient(), userAgent, null, bandwidthMeter);
